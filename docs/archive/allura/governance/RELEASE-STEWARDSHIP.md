...
| `security-privacy` | Security and privacy docs reviewed. | `PARTIAL` | `docs/archive/allura/security/SECURITY-BLUEBOOK.md`, `docs/archive/allura/security/SOC2-READINESS-CHECKLIST.md`, and privacy-sensitive sample audit. |
