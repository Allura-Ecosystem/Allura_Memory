...
> `docs/goal.md`, native Allura Kanban or configured board adapter state,
> source code, and Team RAM review.

This document standardizes the Phase 3 governance formats for Allura Memory.
Native Allura Kanban is the default work-board source of truth; Notion, Linear,
and GitHub Projects are optional adapters. Allura Brain receipts are audit traces,
not proof of done. Evidence proves done.
