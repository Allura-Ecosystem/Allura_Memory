...
- `infographics/svg/` — six editable SVG infographics with embedded accessibility metadata.
- `infographics/png/` — presentation-ready PNG renders of the same assets.
- `deck/Allura-Agentic-AI-Framework-Harness-Portfolio.pptx` — a ten-slide presentation with speaker-note sources.
- `ROLE-MAPPING.md` — role requirements mapped to inspectable Allura evidence.
- `SOURCES.md` and `ALT-TEXT.md` — provenance and accessible descriptions.
- `BRAND-AUDIT.md`, `BRAND-SOURCE-RESOLUTION.md`, and `qa/BRAND-RELEASE-GATE.md` — the remediation decision and release review.
