...
This agent is mirrored from `plugins/allura-agents/agents/bahari.md`. The canonical definition lives in the plugin. This file exists for Claude Code activation.
