...
const __TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:280px;
    ...
    background:rgba(250,249,247,.78);color:#111827;
  ...
  .twk-x{appearance:none;border:0;background:transparent;color:rgba(17,24,39,.55);
    width:22px;height:22px;border-radius:6px;cursor:default;font-size:13px;line-height:1}
  .twk-x:hover{background:rgba(0,0,0,.06);color:#111827}
  ...
  .twk-toggle[data-on="1"]{background:#157A4A}
