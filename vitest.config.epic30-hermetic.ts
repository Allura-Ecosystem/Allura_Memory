...
export default defineConfig({ ...unit, test: { ...unit.test,
  ...
  include: [
    ...
    "tests/scripts/epic30-completion.test.ts",
    ...
    "src/__tests__/trace-receipt-authority.test.ts",
    ...
    "src/__tests__/canonical-delete-lifecycle-authority.test.ts",
    "src/lib/digital-brain/document-links.test.ts",
    "src/lib/digital-brain/document-citations.test.ts",
    "src/lib/digital-brain/document-derivatives.test.ts",
    "src/lib/digital-brain/ask-context.test.ts",
    "src/lib/digital-brain/ask-answer.test.ts",
    "src/lib/digital-brain/production-ask.test.ts",
    "src/lib/digital-brain/cache-authority.test.ts",
    ...
    "src/lib/digital-brain/restricted-messaging.test.ts",
    "src/lib/digital-brain/restricted-messaging-production.test.ts",
    "src/lib/digital-brain/workspace-membership-lifecycle.test.ts",
    "src/lib/digital-brain/workspace-membership-production.test.ts",
    "src/lib/digital-brain/synthetic-fixture-contract.test.ts",
    "src/lib/postgres/connection.app-pool.test.ts",
    "src/lib/graph-adapter/__tests__/ruvector-workspace-authority.test.ts",
