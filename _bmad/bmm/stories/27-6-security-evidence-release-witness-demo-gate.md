...
- [ ] Tenant/workspace isolation tests pass, including cross-tenant inheritance failing
      closed (live-database evidence, per the epic exit gate).
- [ ] Poisoning, replay, tamper, quota, expiry, and rollback tests pass.
- [ ] One machine-readable release manifest is produced containing revision, tests,
...
- [ ] Production adoption remains gated on license, provenance, security, and benchmark
