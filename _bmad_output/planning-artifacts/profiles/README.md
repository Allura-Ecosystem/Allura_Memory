...
```bash
docker mcp profile export openclaw ./_bmad_output/planning-artifacts/profiles/openclaw.yaml
docker mcp profile export faithmeats ./_bmad_output/planning-artifacts/profiles/faithmeats.yaml
docker mcp profile export difference-driven ./_bmad_output/planning-artifacts/profiles/difference-driven.yaml
docker mcp profile export coding ./_bmad_output/planning-artifacts/profiles/coding.yaml
```
...
```bash
docker mcp profile import ./_bmad_output/planning-artifacts/profiles/openclaw.yaml
docker mcp profile import ./_bmad_output/planning-artifacts/profiles/faithmeats.yaml
docker mcp profile import ./_bmad_output/planning-artifacts/profiles/difference-driven.yaml
docker mcp profile import ./_bmad_output/planning-artifacts/profiles/coding.yaml
```
