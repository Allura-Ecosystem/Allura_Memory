...
**Repository authority:** [`sprint-status.yaml`](../implementation-artifacts/sprint-status.yaml) for tracked story status; source, tests, PRs, and evidence for implementation truth.
...
| 25.2a | Workspace Scope and Evidence Lifecycle Foundation | Done | [`25-2a-workspace-evidence-lifecycle-foundation.md`](../implementation-artifacts/25-2a-workspace-evidence-lifecycle-foundation.md) |
| 25.2b | Authenticated Session Entry Point | Done | [`25-2b-authenticated-session-entry-point.md`](../implementation-artifacts/25-2b-authenticated-session-entry-point.md) |
| 25.3a | Curator Read Contract and Workspace Authority Remediation | Done | [`25-3a-curator-read-contract-remediation.md`](../implementation-artifacts/25-3a-curator-read-contract-remediation.md) |
| 25.3b | Modular Dashboard Workflow Contract Registry | In review | [`25-3b-modular-dashboard-workflow-contract-registry.md`](../implementation-artifacts/25-3b-modular-dashboard-workflow-contract-registry.md) |
