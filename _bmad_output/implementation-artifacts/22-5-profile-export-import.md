...
- [ ] AC-1: A README exists at `_bmad_output/planning-artifacts/profiles/README.md` documenting each profile, its tenant, tools, and restrictions
...
- [ ] AC-4: Each profile has a YAML file in `_bmad_output/planning-artifacts/profiles/` (exported and committed)
...
1. Export each profile: `docker mcp profile export openclaw ./_bmad_output/planning-artifacts/profiles/openclaw.yaml` (repeat for each)
2. Create `_bmad_output/planning-artifacts/profiles/README.md`
...
- `_bmad_output/planning-artifacts/profiles/README.md` (NEW)
- `_bmad_output/planning-artifacts/profiles/openclaw.yaml` (NEW — exported)
- `_bmad_output/planning-artifacts/profiles/faithmeats.yaml` (NEW — exported)
- `_bmad_output/planning-artifacts/profiles/difference-driven.yaml` (NEW — exported)
- `_bmad_output/planning-artifacts/profiles/coding.yaml` (NEW — exported)
