...
**Status:** done — all 10 ACs verified 2026-08-29; implementation (PR #84 + Knuth remediation) passed CI; 4-layer code review covered the remediation diff; no open findings.
