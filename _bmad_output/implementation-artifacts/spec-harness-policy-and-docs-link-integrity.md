...
- `_bmad_output/implementation-artifacts/deferred-work.md` -- update DW-1 and DW-2 outcomes only after verification; preserve history and source/evidence references.
...
- [x] `_bmad_output/implementation-artifacts/deferred-work.md` -- record resolved evidence for DW-1/DW-2 or retain only genuinely deferred scope -- keeps governance ledger truthful.
