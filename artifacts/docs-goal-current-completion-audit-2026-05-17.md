...
- `docs/allura/SOLUTION-ARCHITECTURE.md` and `docs/allura/RISKS-AND-DECISIONS.md` (cutover readiness was later condensed into canonical docs)
...
| Finish Phase 4 dashboard cutover readiness. | Cutover readiness was condensed into `docs/allura/SOLUTION-ARCHITECTURE.md` and `docs/allura/RISKS-AND-DECISIONS.md`; `src/__tests__/dashboard-cutover-readiness.test.ts`; Notion `3631d9be-65b3-81c2-9295-e0cdd91a714d`; Brain `ff54f1cd-931f-4472-be52-64be124ce092`. | `BLOCKED/PARTIAL` | Route parity, visual parity, adapter declarations, no-fabricated-live-data audit, auth validation, full smoke tests, runtime health, tested rollback, and Captain approval remain incomplete. `3100` must not be replaced. |
...
| Finish Phase 6 security/privacy review. | `docs/archive/allura/security/SECURITY-BLUEBOOK.md`, `docs/archive/allura/security/SOC2-READINESS-CHECKLIST.md`, focused public-surface release scan. | `PARTIAL` | Full external secret/sample scan still required. |
