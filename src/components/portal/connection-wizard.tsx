...
export function ConnectionWizard({ endpoint, isAdmin = false, workspaceId }: Props) {
  ...
  return <div className={styles.clients}>
    ...
    {view === "credentials" ? <section className={styles.credentialPanel} aria-label="Manage access">
      ...
      {canIssue ? <TokenInventoryPanel isAdmin={isAdmin} workspaceId={workspaceId!} /> :
      ...
      <section className={styles.setup} aria-labelledby="client-setup-heading">
        ...
        {selected.ready ? <>
          <div className={styles.credentialPanel}>
            ...
            <TokenIssuerPanel key={`${selected.id}:${workspaceId}`} isAdmin={canIssue} workspaceId={workspaceId} initialAgentName={selected.name} onIssuingChange={setIssuing} />
          </div>
      ...
      <section aria-labelledby="clients-heading">
        <header className={styles.intro}>
          <div><h2 id="clients-heading">Connect your AI tools</h2>
            <p>Choose a client to set up access to your Allura memory workspace.</p></div>
        </header>
