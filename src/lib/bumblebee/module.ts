/**
 * Bumblebee's allowlisted declarative module manifest and local rollback flag.
...
export type ModuleDescriptor = CuratorModuleManifest & { readonly surfaces: readonly string[] }
