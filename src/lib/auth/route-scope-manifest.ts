...
export const ROUTE_SCOPE_MANIFEST: RouteScopeEntry[] = [
  ...
  },
  {
    ...
    methods: ["POST"],
    authStrategy: "principal",
    description: "Mark an owned or same-tenant-admin-authorized paired device lost",
  },
  {
    pattern: "/api/device-pairing/revoke",
    requiredRole: "viewer",
    scopeName: "device-pairing:revoke",
    methods: ["POST"],
    authStrategy: "principal",
    description: "Revoke an owned or same-tenant-admin-authorized paired device",
  },
  {
